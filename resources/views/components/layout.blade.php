...
<div class="min-h-full">
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">christian</div>
            <div class="text-sm font-medium leading-none text-gray-400">jhonchristiansolano@gmail</div>
          </div>
  ...
  <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900"> {{ $heading1 }} </h1>
    </div>
  </header>
  <main>
